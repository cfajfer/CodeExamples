        ...
        return (
            <div className="sidenav">
                ...
                <div className="sidenav__nav-section sidenav__nav-section--padding">
                    ...
                    <ul className="footer__social-list sidenav__ourteam-socials">
                        <li className="footer__social-item">
                            <a href="#" style={{backgroundColor: '#1cb7eb'}}>
                                <Twitter className="footer__social-image" />
                            </a>
                        </li>
                        <li className="footer__social-item">
                            <a href="#" style={{backgroundColor: '#8192e9'}}>
                                <Discord className="footer__social-image" />
                            </a>
                        </li>
                        <li className="footer__social-item">
                            <a href="#" style={{backgroundColor: '#3a579b'}}>
